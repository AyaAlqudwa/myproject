...
<body>
  ...
  <div class="container"style="margin-bottom:100px;">
      <div class="card">
          <div class="card-header text-center"><h4>اضافة طالب</h4></div>
          <div class="card-body">
...
<!-------------------------------------------->
    <?php
     ...
     if (isset($_POST['submit'])) {
        ...
        $depnum=$_POST['depnum'];
        if (empty($name) or empty($email) or empty($age) or empty($address) or empty($phone)or empty($depnum) ) {
            echo"<div class='alert alert-danger' role='alert'>الرجاء ادخال القيم</div>";
        }
        else{
